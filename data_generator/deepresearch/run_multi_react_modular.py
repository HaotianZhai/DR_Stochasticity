...
from react_agent_modular import ModularReactAgent
...
Examples:
  ...
  python run_multi_react_modular.py --model "Qwen3-30B-A3B-Instruct-2507" \\
    ...
    parser.add_argument("--use-structure", action="store_true",
                       help="Enable structured output enforcement (legacy: summarize/reasoning)")
    parser.add_argument("--use-structure-1", action="store_true",
                       help="Enable structured summarization (findings + citations)")
    parser.add_argument("--use-structure-2", action="store_true",
                       help="Enable structured reasoning (facts/questions/directions)")
    ...
    print(f"  use_structure_1:{args.use_structure_1}")
    print(f"  use_structure_2:{args.use_structure_2}")
    if rollout_seeds:
        ...
        for item in items:
            ...
            if question and question not in processed:
                task = {
                    ...
                    "planning_port": 6001,  # Placeholder for compatibility
                }
    ...
    agent = ModularReactAgent(
        ...
        mitigation_config={
            ...
            "use_structure_1": args.use_structure_1,
            "use_structure_2": args.use_structure_2,
        }
    )
